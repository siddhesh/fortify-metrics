...
test_unknown (size_t cnt, size_t sz)
{
  ...
  size_t ret = __builtin_object_size (ch, 0);
  __builtin_free (ch);
  return ret;
}
...
test_builtin_malloc_condphi4 (size_t sz, int cond)
{
  ...
  size_t ret = __builtin_object_size (cond ? b : (void *) &a, 0);
  __builtin_free (a);
  return ret;
}
...
test_builtin_malloc_condphi5 (size_t sz, int cond, char *c)
{
  ...
  size_t ret = __builtin_object_size (cond ? c : (void *) &a, 0);
  __builtin_free (a);
  return ret;
}
...
test_builtin_malloc_long (long sz, long off)
{
  ...
  char *dest = a + off;
  long ret = __builtin_object_size (dest, 0);
  return ret;
}
...
test_builtin_calloc_condphi (size_t cnt, size_t sz, int cond)
{
  ...
  size_t ret = __builtin_object_size (cond ? ch : (void *) &bin, 0);
...
test_passthrough (size_t sz, char *in)
{
  ...
  size_t ret = __builtin_object_size (dest, 0);
  __builtin_free (bin);
  return ret;
}
...
test_passthrough_nonssa (char *in)
{
  ...
  return __builtin_object_size (dest, 0);
}
...
test_dynarray (size_t sz)
{
  ...
  return __builtin_object_size (bin, 0);
}
...
test_dynarray_struct (size_t sz, size_t off)
{
  ...
  return __builtin_object_size (&bin[off].c, 0);
}
...
test_dynarray_struct_subobj (size_t sz, size_t off)
{
  ...
  return __builtin_object_size (&bin[off].c[4], 1);
}
...
test_dynarray_struct_subobj2 (size_t sz, size_t off, size_t *objsz)
{
  ...
  *objsz = sizeof (bin);
  ...
  return __builtin_object_size (&bin.c[off], 1);
}
...
test_substring (size_t sz, size_t off)
{
  ...
  return __builtin_object_size (&str[off], 0);
}
...
{
  struct S2 *s2 = &s1->s2;
  return __builtin_object_size (s2->arr, 0);
}
...
test_substring_ptrplus2 (size_t sz, size_t off, size_t off2)
{
  ...
  return __builtin_object_size (ptr + off2, 0);
}
...
{
  return __builtin_object_size (obj + off, 0);
}
...
{
  return __builtin_object_size (cond ? obj : unknown, 0);
}
...
test_loop (int *obj, size_t sz, size_t start, size_t end, int incr)
{
  ...
  for (int i = start; i != end; i = i + incr)
    {
      ptr = ptr + incr;
      if (__builtin_object_size (ptr, 0) == 0)
	return 0;
    }
...
test_strdup (const char *in)
{
  ...
  return __builtin_object_size (res, 0);
}
...
{
  char *res = __builtin_strdup (in);
  return __builtin_object_size (res, 2);
}
...
main (int argc, char **argv)
{
  ...
  if (__builtin_object_size (t, 0) != -1)
    FAIL ();
